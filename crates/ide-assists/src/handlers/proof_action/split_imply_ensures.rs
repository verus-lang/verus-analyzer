...
use syntax::ast::{self, AstNode, LogicOp, vst::*};

pub(crate) fn split_imply_ensures(acc: &mut Assists, ctx: &AssistContext<'_, '_>) -> Option<()> {
    ...
    acc.add(
        AssistId("split_imply_ensures", AssistKind::RefactorRewrite, None),
