...
impl<'a, 'db> AssistContext<'a, 'db> {
    ...
    pub(crate) fn vst_path_from_text(&self, text: &str) -> Option<vst::Path> {
    ...
    pub(crate) fn vst_call_expr_from_text(
        &self,
        fn_name: &str,
        arglist: vst::ArgList,
    ) -> Option<vst::CallExpr> {
    ...
    pub(crate) fn vst_nameref_from_text(&self, s: &str) -> Option<vst::NameRef> {
    ...
    pub(crate) fn vst_expr_from_text(&self, s: &str) -> Option<vst::Expr> {
