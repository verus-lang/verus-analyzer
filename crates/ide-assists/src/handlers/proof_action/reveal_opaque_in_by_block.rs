...
use syntax::ast::{self, AstNode, vst::*};

pub(crate) fn assert_by_reveal(acc: &mut Assists, ctx: &AssistContext<'_, '_>) -> Option<()> {
    ...
    acc.add(
        AssistId("assert_by_reveal", AssistKind::RefactorRewrite, None),
